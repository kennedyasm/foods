...
object AppIcons {
    val cameraIcon = Icons.Default.Camera
    val stopIcon = Icons.Default.Stop
    val recordIcon = Icons.Default.FiberManualRecord
    val micIcon = Icons.Default.Mic
    ...
    val brokenImageIcon = Icons.Default.BrokenImage
