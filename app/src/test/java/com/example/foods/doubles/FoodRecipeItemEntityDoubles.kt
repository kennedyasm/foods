...
fun provideFoodRecipeItemEntityList() = listOf(
    ...
    provideCaldoDeCamaronFoodRecipeItemEntity()
)
...
fun provideBowThaiFoodRecipeItemEntity() =
    FoodRecipeItemEntity(
        ...
        bowlThaiIngredientsForEntity,
        bowlThaiPreparationForEntity,
...
val bowlThaiIngredientsForEntity = listOf(
    "1 pechuga de pollo",
...
val bowlThaiPreparationForEntity = listOf(
...
fun provideCaldoDeCamaronFoodRecipeItemEntity() =
    FoodRecipeItemEntity(
        2,
        "CALDO DE PIEDRA",
        ...
        caldoDePiedraIngredientsForEntity,
        caldoDePiedraPreparationForEntity,
...
val caldoDePiedraIngredientsForEntity = listOf(
...
val caldoDePiedraPreparationForEntity = listOf(
